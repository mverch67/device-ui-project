...
#define _meshtastic_Routing_Error_ARRAYSIZE                                                                                      \
    ((meshtastic_Routing_Error)(meshtastic_Routing_Error_ADMIN_PUBLIC_KEY_UNAUTHORIZED + 1))
...
#define meshtastic_DeviceMetadata_init_default                                                                                   \
    {                                                                                                                            \
        "", 0, 0, 0, 0, 0, _meshtastic_Config_DeviceConfig_Role_MIN, 0, _meshtastic_HardwareModel_MIN, 0, 0                      \
    }
